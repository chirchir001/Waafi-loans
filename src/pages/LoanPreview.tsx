      ...
      <div className="max-w-[800px] mx-auto">
        <div className="bg-white rounded-[20px] card-shadow p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Fiiri Lidiyaankaaga</h2>
            <p className="text-slate-500">Ku yaal kharabkaaga</p>
          </div>
            ...
            <div className="border-l-4 border-waafi-purple bg-gradient-to-r from-waafi-soft-purple/50 to-transparent rounded-r-xl p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex-1">
                  <p className="text-sm text-slate-500 mb-1">Kharabka</p>
                  {isEditing ? (
                ...
                <div className="flex gap-6">
                  <div>
                    <p className="text-xs text-slate-500">Interest Rate (Sugayn)</p>
                    <p className="text-sm font-semibold text-slate-700">{rate}%</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-500">Duration (Waqtiga)</p>
