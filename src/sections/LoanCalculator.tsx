      ...
      <div className="max-w-[800px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-2">His Kharabka</h2>
            <p className="text-slate-500">Helinta lacagta maalintii</p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-8">
            ...
            >
              <label className="text-sm font-medium text-slate-700 mb-2 block">Kharabka</label>
            ...
            >
              <label className="text-sm font-medium text-slate-700 mb-2 block">Interest Rate (Sugayn)</label>
            ...
            >
              <label className="text-sm font-medium text-slate-700 mb-2 block">Waqtiga Bixinta</label>
          ...
          <div className="border-l-4 border-waafi-purple bg-gradient-to-r from-waafi-soft-purple/50 to-transparent rounded-r-xl p-6 mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <p className="text-sm text-slate-500 mb-1">Lacagta Maalintii</p>
                <p className="text-2xl font-bold text-slate-900">{formatCurrency(animatedPayment)}</p>
              </div>
              <div className="flex gap-6">
                <div>
                  <p className="text-xs text-slate-500">Total Interest (Intar)</p>
                  <p className="text-sm font-semibold text-slate-700">{formatCurrency(animatedInterest)}</p>
                </div>
                <div>
                  <p className="text-xs text-slate-500">Total Repayment (Kharab)</p>
