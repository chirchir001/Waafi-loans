  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-3">Lidiyaan Kumeel</h2>
