...
const loans: Loan[] = [
  { id: 1, name: "Lidiyaan Shakhsi", startDate: "Jan 15, 2025", amount: 5000, paid: 3250, apr: 8.5, monthsLeft: 13 },
  { id: 2, name: "Lidiyaan Business", startDate: "Feb 20, 2025", amount: 12000, paid: 3600, apr: 10.2, monthsLeft: 22 },
];
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-[60%]">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-slate-900">Lidiyaan kula jirta</h3>
          ...
          <div className="lg:w-[40%]">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Bixinta soo socda</h3>
