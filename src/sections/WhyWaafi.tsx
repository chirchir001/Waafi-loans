...
const features = [
  { image: "/images/bank.svg", title: "Bank Aamin", description: "Bank-level 256-bit encryption and multi-factor authentication on every transaction." },
  { image: "/images/card.svg", title: "Card Fariin Deg", description: "Get a virtual debit card the moment your loan is approved. Shop online immediately." },
  { image: "/images/payments.svg", title: "Payments Soo Rara", description: "Send and receive money instantly across borders with near-zero fees." },
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">
            Wixii kuu suurtoobahay, App hal
          </h2>
          <p className="text-sm text-slate-500 max-w-[460px] mx-auto">
            WAAFI ku jira loans, payments, iyo financial tools so you have total control of your money.
          </p>
        </motion.div>
