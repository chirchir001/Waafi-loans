...
const loanData = [
  { name: "Shakhsi", value: 7740, color: "#8B5CF6" },
  { name: "Business", value: 5160, color: "#14B8A6" },
  { name: "Xaggeed", value: 2580, color: "#F59E0B" },
  { name: "Waxbarasho", value: 1720, color: "#3B82F6" },
];
    ...
    <section className="bg-ghost-white py-20">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-xl font-bold text-slate-900 mb-6">Credit Score</h3>
          ...
          <motion.div
            ...
            className="bg-white rounded-[20px] card-shadow p-6 sm:p-8"
          >
            <h3 className="text-xl font-bold text-slate-900 mb-6">Isticmaalka Lidiyaanka</h3>
