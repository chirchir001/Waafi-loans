              ...
              <div className="gradient-purple-teal p-6 relative overflow-hidden">
                ...
                <div className="relative flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-white">Fadlan Xaqiiqdada</h3>
                    <p className="text-white/65 text-xs mt-1">Ka oggolaada intaadaa u heli 60 saac</p>
                  </div>
                  <button
                    onClick={handleClose}
                  ...
                  {!showResult ? (
                    ...
                    >
                      <div className="relative">
                        ...
                        <input
                          type="number"
                          placeholder="Dakhafka Maalintii"
                          value={income}
                      ...
                      >
                        ...
                        <option value="employed">Shaqo oo dhan</option>
                        <option value="self-employed">Self-employed</option>
                        <option value="business">Maalase</option>
                      ...
                      >
                        ...
                        <option value="excellent">Aad u eg (750+)</option>
                        <option value="good">Good (650–749)</option>
                        <option value="fair">Fair (550–649)</option>
                        <option value="poor">Bad (Below 550)</option>
                      </select>
                      <button
                        onClick={handleCheck}
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-500 mb-1">Waxaad ku heli doonidin</p>
                      <p className="text-3xl font-extrabold text-waafi-purple mb-1">
                        ${eligibleAmount.toLocaleString()}
                      </p>
                      <p className="text-[11px] text-slate-400 mb-6">Dakhafkaaga</p>
