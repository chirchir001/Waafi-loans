...
const steps = [
  {
    number: "01",
    Icon: ClipboardCheck,
    title: "Fadlan Xaqiiqdada",
    description: "Jaw so aalaban 3 su'aal ku saabeq about your income and credit. Get your result in under 60 seconds.",
      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">
            3 Xarala oo Kharabkaaga
          </h2>
          <p className="text-sm text-slate-500 max-w-[380px] mx-auto">
            Waligayn. Waligayn gelin. Online toos ah.
          </p>
        </motion.div>
        ...
        >
          Waqtti ugu yar:{" "}
          <span className="text-slate-600 font-semibold">5 daqiiq good</span>
        </motion.p>
      </div>
    </section>
  );
